...
1. Read and apply the `writing-for-agents` Skill as the writing style guide.
...
- **Coding standards**: when a review stage or reviewer agent exists, should it receive a new rule to enforce? Should an existing rule be removed or clarified? _Use when_ review failed to catch a mistake.
